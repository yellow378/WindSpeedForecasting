  ...
  do
    ...
    do 
      ...
      do  
        ...
        # 定义日志文件路径
        log_file="logs/LongForecasting/${model_name}_${model_id_name}_${seq_len}_${pred_len}_${rnn_type}_${d_model}_${seg_len}.log"
        # 如果日志文件存在，则删除它
        if [ -f "$log_file" ]; then
            rm "$log_file"
